...
func (s *DownwardAPIVolume) ToKube(version string) (runtime.Object, error) {
...
func (s *DownwardAPIVolume) getReflectObjectFromInterface(iface runtime.Object) reflect.Value {
